		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					<!-- social -->
					<ul class="nav-social">
						<li><a href="https://www.instagram.com/nonabears.id/"><i class="fa fa-facebook"></i></a></li>
						<li><a href="https://www.instagram.com/nonabears.id/"><i class="fa fa-instagram"></i></a></li>
					</ul>
					<!-- /social -->
						...
						<li class="has-dropdown">
							...
							<div class="dropdown">
								<div class="dropdown-body">
									...
									<li><a href="{{ route('blog.category', $hasil1->slug) }}">{{ $hasil1->name }}</a></li>
									@endforeach
									</ul>
								</div>
							</div>
